...
```mermaid
graph TD
    B1["วิทยาการคำนวณ 1 (Foundations)"] --> P1["ส่วนที่ 1: ตรรกะและแนวคิดเชิงคำนวณ (บทที่ 1-4)"]
    B1 --> P2["ส่วนที่ 2: ขั้นตอนวิธีและรากฐานโปรแกรม (บทที่ 5-10)"]
    
    P1 --> C1["บทที่ 1 การใช้เหตุผลเชิงตรรกะและการสำรวจปริภูมิสถานะ
(Lab 1.0 - 1.4: River Crossing / EV Tree / Fib Wave / Point Mass / Grid)"]
    P1 --> C2["บทที่ 2 การออกแบบขั้นตอนวิธีและผังงานมาตรฐาน
(Lab 2.0 - 2.4: Mars Unit / AST / Flowchart / Decision / Trace Table)"]
    P1 --> C3["บทที่ 3 การเขียนรหัสลำลองและผังงานเชิงลึก"]
    P1 --> C4["บทที่ 4 กิจกรรม Unplugged Coding และอัลกอริทึมในชีวิตประจำวัน"]
    
    P2 --> C5["บทที่ 5 โครงสร้างข้อมูลเบื้องต้นและตัวแปรในหน่วยความจำ"]
    P2 --> C6["บทที่ 6 โครงสร้างทางเลือกและการตัดสินใจ"]
    P2 --> C7["บทที่ 7 โครงสร้างการทำงานซ้ำและการวนลูป"]
    P2 --> C8["บทที่ 8 วิทยาศาสตร์เชิงคำนวณและแบบจำลองการเคลื่อนที่"]
    P2 --> C9["บทที่ 9 ปัญญาประดิษฐ์และคอมพิวเตอร์วิทัศน์ 21 ข้อต่อ"]
    P2 --> C10["บทที่ 10 การพัฒนาโครงงานนวัตกรรมและการประมวลความรู้"]
```
