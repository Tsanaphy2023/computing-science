...
### (Computing Science I: Foundations of Computational Thinking & Systematic Problem Solving)
...
ตำราเล่มนี้มุ่งเน้นการสร้าง **ฐานคิดเชิงตรรกะและกระบวนการคิดเชิงคำนวณ (Computational Thinking)** ให้แก่ผู้เรียนตั้งแต่ระดับพื้นฐาน โดยไม่จำกัดอยู่เพียงแค่การเขียนโค้ดหน้าจอคอมพิวเตอร์ แต่เน้นการมองปัญหาในชีวิตประจำวัน ปัญหาทางคณิตศาสตร์ และวิทยาศาสตร์อย่างเป็นระบบ ผ่านกิจกรรม **Unplugged Coding** การเขียน **รหัสลำลอง (Pseudocode)** และ **ผังงาน (Flowchart)** ก่อนเปลี่ยนผ่านสู่การเขียนโปรแกรมคอมพิวเตอร์อย่างง่ายด้วยภาษาที่เป็นมิตร เช่น Block-based Programming และ Python เบื้องต้น
...
* **2.1 เสาหลักที่ 1: การแยกส่วนประกอบและการย่อยปัญหา (Decomposition)**
...
* **3.1 การเขียนรหัสลำลอง (Pseudocode)**
