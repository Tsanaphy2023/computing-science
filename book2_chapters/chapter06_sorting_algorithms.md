...
## บทที่ 6 อัลกอริทึมการจัดเรียงข้อมูล (Sorting Algorithms)
...
1. **อธิบาย (Explain)** กลไกการทำงาน ความเสถียร (Stability) และความซับซ้อน Big-O ของอัลกอริทึมการจัดเรียงข้อมูลแบบคลาสสิก
2. **วิเคราะห์และเปรียบเทียบ (Analyze & Compare)** ประสิทธิภาพระหว่าง Bubble Sort, Selection Sort, Insertion Sort ($O(n^2)$) และ Merge Sort ($O(n \log n)$)
3. **ออกแบบและเขียนโค้ด (Code & Implement)** อัลกอริทึมการแบ่งแยกเพื่อพิชิต (Divide & Conquer) ใน Merge Sort
4. **เลือกใช้อัลกอริทึมการจัดเรียง (Select Optimal Sorter)** ให้เหมาะสมกับขนาดและลักษณะเฉพาะของข้อมูลในสถานการณ์จริง
...
### 2. ซีเลกชันซอร์ต (Selection Sort)
วนลูปหา **ค่าที่น้อยที่สุด (Minimum)** ในส่วนที่ยังไม่เรียง แล้วนำมาสลับกับตำแหน่งแรก ทำซ้ำเช่นนี้ไปเรื่อยๆ

### 3. อินเซอร์ชันซอร์ต (Insertion Sort)
หยิบสมาชิกทีละตัวมา **แทรก (Insert)** ลงในตำแหน่งที่ถูกต้องของส่วนหน้าที่เรียงลำดับแล้ว คล้ายกับการจัดเรียงไพ่ในมือ
...
## ⚡ 6.3 เมิร์จซอร์ต (Merge Sort): การแบ่งแยกเพื่อพิชิต (Divide & Conquer)
