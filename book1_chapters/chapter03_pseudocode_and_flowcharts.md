...
1. **อธิบาย (Explain)** ความหมาย วัตถุประสงค์ และประโยชน์ของการใช้รหัสลำลอง (Pseudocode) และผังงาน (Flowchart) ในการสื่อสารขั้นตอนวิธี
2. **เลือกใช้และวาด (Select & Draw)** สัญลักษณ์ผังงานตามมาตรฐานสากล ANSI/ISO ได้อย่างถูกต้องครบถ้วน
3. **แปลง (Translate)** โจทย์ปัญหาทางคณิตศาสตร์และวิทยาศาสตร์ให้อยู่ในรูปโครงสร้างควบคุม 3 รูปแบบ (เรียงลำดับ, ทางเลือก, ทำซ้ำ)
4. **ตรวจสอบความถูกต้อง (Verify & Debug)** ของขั้นตอนวิธีด้วยตารางตรวจสอบการทำงาน (Trace Table / Dry Run) ได้อย่างแม่นยำ
...
## 📜 3.1 การเขียนรหัสลำลองตามหลักสากล (Standard Pseudocode)

**รหัสลำลอง (Pseudocode)** คือ การอธิบายขั้นตอนวิธีของการแก้ปัญหาด้วยภาษาที่กึ่งภาษาธรรมชาติและกึ่งภาษาโปรแกรม โดยไม่ยึดติดกับไวยากรณ์ (Syntax) ของภาษาคอมพิวเตอร์ภาษาใดภาษาหนึ่งโดยเฉพาะ

### คำสำคัญมาตรฐานสากล (Standard Keywords)
...
**ผังงาน (Flowchart)** คือ แผนภาพที่ใช้รูปทรงเรขาคณิตมาตรฐานสากลในการแสดงลำดับขั้นตอนการทำงานของระบบหรือโปรแกรม
...
## 🔄 3.3 โครงสร้างการควบคุมหลัก 3 รูปแบบ (3 Control Structures)
...
## 📝 3.4 ตัวอย่างโจทย์คำนวณและการตรวจสอบด้วยตารางดรายรัน (Dry Run / Trace Table)
