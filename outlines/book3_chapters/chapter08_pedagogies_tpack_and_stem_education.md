...
## บทที่ 8 นวัตกรรมการจัดการเรียนรู้วิทยาการคำนวณสำหรับครูยุคใหม่ (Computing Science Pedagogies, TPACK & STEM Education)
...
1. **อธิบาย (Explain)** กรอบแนวคิด TPACK (Technological Pedagogical Content Knowledge) และทฤษฎีการสร้างสรรค์ความรู้ด้วยปัญญา (Constructionism) ในการสอนวิทยาการคำนวณ
2. **ออกแบบแผนการจัดการเรียนรู้เชิงรุก (Design Active Learning Lesson Plans)** ตามกระบวนการสืบเสาะ 5 ขั้น (5E Instructional Model) และสะเต็มศึกษา (STEM/STEAM Education)
3. **สร้างเครื่องมือวัดและประเมินผล (Develop Assessment Rubrics)** ตามสภาพจริง (Authentic Assessment) ทั้งด้านทักษะกระบวนการคิด ทักษะการเขียนโปรแกรม และทักษะการแก้ปัญหา
4. **บูรณาการสื่อนวัตกรรมดิจิทัล (Integrate Digital Learning Media)** เช่น AR Simulators, MediaPipe, และ MOOC เพื่อยกระดับห้องเรียนวิทยาการคำนวณในศตวรรษที่ 21
...
## 🔄 8.2 การออกแบบกิจกรรมการเรียนรู้แบบ Active Learning (5E Model)
...
## 🏆 8.3 เกณฑ์การวัดและประเมินผลตามสภาพจริง (Authentic Assessment Rubrics)

| มิติการประเมิน | ยอดเยี่ยม (4 คะแนน) | ดี (3 คะแนน) | พอใช้ (2 คะแนน) | ปรับปรุง (1 คะแนน) |
| :--- | :--- | :--- | :--- | :--- |
| **1. ทักษะแนวคิดเชิงคำนวณ (CT)** | ย่อยปัญหาและสกัดแก่นนามธรรมได้อย่างสมบูรณ์แบบ | วิเคราะห์ปัญหาได้ดี มีขั้นตอนวิธีชัดเจน | ย่อยปัญหาได้บางส่วน ขาดความกระชับ | ไม่สามารถแยกแยะปัญหาได้ |
