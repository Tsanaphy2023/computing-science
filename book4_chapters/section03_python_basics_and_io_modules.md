...
## หมวดหมู่ที่ 3 พื้นฐานการเขียนโปรแกรมและการจัดการข้อมูล (Python Basics & Data Types)
...
### 🔹 โมดูล 3.2: ชนิดข้อมูลพื้นฐานและการแปลงชนิด (Data Types & Type Casting)
...
### 🔹 โมดูล 3.4: การรับข้อมูลเข้าและการจัดรูปแบบการแสดงผล (f-string Formatting)
