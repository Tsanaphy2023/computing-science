...
## หมวดหมู่ที่ 2 การออกแบบขั้นตอนวิธีและผังงานมาตรฐาน (Algorithms & Flowcharts Modules)
...
## 🎯 ผลลัพธ์การเรียนรู้ประจำหมวดที่ 2 (Module Learning Outcomes)
1. **CLO 1:** เขียนรหัสลำลอง (Pseudocode) ตามมาตรฐานสากลที่มีโครงสร้างชัดเจนและปราศจากความกำกวม
2. **CLO 2:** ออกแบบและวาดผังงาน (Flowcharts) ตามมาตรฐาน ISO 5807 ด้วยโครงสร้างควบคุม 3 รูปแบบ (ลำดับ ทางเลือก วนซ้ำ)
...
## 📚 รายละเอียด 5 โมดูลบทเรียนดิจิทัลและห้องปฏิบัติการเสมือนจริง (Hybrid 2D/3D Labs)
...
### 🔹 โมดูล 2.0: ปฐมบทขั้นตอนวิธี บทเรียนยานอวกาศ Mars กับมาตรฐานการสื่อสาร (Mars Unit Converter)
...
### 🔹 โมดูล 2.1: การเขียนรหัสลำลองตามหลักสากลและการสร้างต้นไม้ไวยากรณ์ (Standard Pseudocode & AST)
...
### 🔹 โมดูล 2.2: สัญลักษณ์ผังงานมาตรฐาน ISO 5807 และโครงสร้างลำดับ (Flowchart Builder Studio)
...
### 🔹 โมดูล 2.3: โครงสร้างทางเลือกและการตัดสินใจหลายเงื่อนไข (Multi-Branch Decision Gates)
...
### 🔹 โมดูล 2.4: โครงสร้างวนซ้ำและการไล่ค่าตัวแปรด้วยตารางดรายรัน (Animated Trace Table Runner)
